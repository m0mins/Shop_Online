# Generated by Django 3.2.23 on 2024-06-11 15:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('is_admin', 'Admin'), ('is_staff', 'Staff'), ('is_user', 'User')], default='user', max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_role', to='App_Accounts.userrole')),
